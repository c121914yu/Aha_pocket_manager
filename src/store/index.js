...
export default new Vuex.Store({
  state: {
	...
	arr_fileTypes: [ //附件类型
		...
		{label: "视频",value: 1,reg: /\.(avi|wmv|mpg|mpeg|mov|rm|ram|swf|raw|flv|mp4|wma|avi|rmvb|mkv)$/i}, //视频,音频
		{label: "文档/PPT",value: 2,reg: /\.(doc|docx|ppt|pptx|xls|xlsx|pdf)$/i}, //文档
