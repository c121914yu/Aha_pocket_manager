	...
	<div class="edit-activity popup">
		<el-form
			...
			<el-form-item label="活动主题" prop="title">
				<el-input v-model="activity.title" placeholder="请输入活动主题"></el-input>
			</el-form-item>
			...
			<el-form-item label="兑换码数量" prop="codeSum">
				<el-input placeholder="兑换码数量" v-model="activity.codeSum"></el-input>
			</el-form-item>
			<el-form-item label="Aha币数量" prop="codeSum">
				<el-input placeholder="每张可兑换Aha币的数量" v-model="activity.exchangeAhaCredit"></el-input>
			</el-form-item>
			<el-form-item label="Aha点数量" prop="codeSum">
				<el-input placeholder="每张可兑换Aha点的数量" v-model="activity.exchangeAhaPoint"></el-input>
			</el-form-item>
...
<script>
import { postActivity } from "@/assets/axios/api_system.js"
export default{
	props: {
		activityInfo: {
			type: Object,
